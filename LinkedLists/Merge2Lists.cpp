...
SinglyLinkedListNode* mergeLists(SinglyLinkedListNode* head1, SinglyLinkedListNode* head2) {
    SinglyLinkedListNode * head1Ref = head1;
    SinglyLinkedListNode * head2Ref = head2;
    ...
    while(head2)
    {
        ...
        SinglyLinkedListNode * toInsert = head2->next;
        head2->next = head1->next;
        head1->next = head2;
        head2 = toInsert;
    }
    return (head1Ref->data > head2Ref->data) ? head2Ref : head1Ref;
}
